...
def parse_arguments():
    ...
    parser.add_argument("--adversarial", action="store_true", 
                        default=False,
                        help="if adversarial attack on object detector")
...
def main(args):
    ...
    #msg_gan.gen, gen_optim = amp.initialize(msg_gan.gen, gen_optim, opt_level="O1")
    #msg_gan.dis, dis_optim = amp.initialize(msg_gan.dis, dis_optim, opt_level="O1")
